...
const AdminNoticeForm = () => {
  ...
  const getHeadingSize = (headingType, baseSize) => {
    ...
    switch (headingType) {
      case '제목1': return `${base + 8}px`;
      case '제목2': return `${base + 6}px`;
      case '제목3': return `${base + 4}px`;
      case '제목4': return `${base + 2}px`;
  ...
  return (
    <>
                ...
                <div>
                  ...
                  <div className="rounded-lg border border-gray-300 bg-white overflow-hidden">
                    <div className="flex items-center gap-3 px-4 py-3 text-sm text-gray-600 border-b border-gray-200">
                      <label htmlFor="admin-notice-image" className="flex items-center gap-2 cursor-pointer font-normal">
      ...
      {showCancelModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4 bg-black/40">
          <div className="relative z-10 w-full max-w-[400px] rounded-2xl bg-white px-8 py-10 text-center shadow-2xl">
            <h3 className="text-xl font-bold text-gray-800 mb-4">글 작성을 그만두시겠습니까?</h3>
            <p className="text-base text-gray-600 mb-8">작성 중인 내용은 저장되지 않습니다</p>
      ...
      {isCompleteOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4 bg-black/40">
          <div className="relative z-10 w-full max-w-[400px] rounded-2xl bg-white px-8 py-10 text-center shadow-2xl">
            <h3 className="text-xl font-bold text-gray-800 mb-4">공지사항이 등록되었습니다</h3>
            <p className="text-base text-gray-600 mb-8">정상적으로 게시글이 등록되었습니다</p>
            <div className="flex gap-4">
              <button
                onClick={() => navigate('/alarm')}
                className="flex-1 h-12 rounded-xl bg-[#2f80ed] text-white font-normal"
